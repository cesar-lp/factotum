...
be erased at the larger ==block== granularity (a block holds many pages), ^card-yc4w
so overwriting a single page in place would require first erasing — and
therefore rewriting — its entire containing block.
